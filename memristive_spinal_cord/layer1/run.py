...
plotter.reset()
plot_neuron_group(Layer1Multimeters.FLEX_MOTOR, Layer1Multimeters.EXTENS_MOTOR, 'Motor V_m, (mV)')
plot_neuron_group(Layer1Multimeters.FLEX_INTER_2, Layer1Multimeters.EXTENS_INTER_2, 'Inter2 V_m, (mV)')
plot_neuron_group(Layer1Multimeters.FLEX_INTER_1A, Layer1Multimeters.EXTENS_INTER_1A, 'Inter1A V_m, (mV)')
plotter.show()
